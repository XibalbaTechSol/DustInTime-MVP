 ...
 */
const Header: React.FC<HeaderProps> = ({ user, onNavigate, onToggleDashboard, theme, onToggleTheme, onSearch, onLogout }) => {
  ...
  return (
    <header className="bg-base-100 dark:bg-neutral shadow-md">
        ...
        <div className="flex justify-between items-center py-3 gap-4">
          ...
          <div className="flex items-center flex-1 min-w-0">
            ...
            >
              ...
              <span className="font-bold text-xl text-neutral-focus dark:text-base-200 hidden sm:inline">Dust in Time - Cleaner App</span>
            </div>
            ...
            {user ? (
              <>
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-56 bg-base-100 dark:bg-neutral rounded-lg shadow-xl py-2 z-[1100] animate-fade-in animate-scale-in origin-top-right">
                      <div 
                        onClick={() => handleNav('settings')}
                      ...
                      <button onClick={() => handleNav('dashboard')} className="w-full text-left block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-base-200 dark:hover:bg-neutral-focus">Dashboard</button>
                       ...
                       <button onClick={onLogout} className="w-full text-left block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-base-200 dark:hover:bg-neutral-focus">Logout</button>
                    </div>
                  )}
                </div>
              </>
