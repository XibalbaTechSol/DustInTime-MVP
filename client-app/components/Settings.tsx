                        ...
                        <div className="space-y-6 pt-6 border-t">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="bathrooms" name="bathrooms" min="0" value={formData.bathrooms || 0} onChange={handleInputChange} className="mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary" />
                                </div>
                            </div>
                            {user.onboardingComplete === 0 && (
                                <div className="pt-4 border-t">
                                    ...
                                    <button onClick={() => onNavigate('clientOnboarding')} className="btn btn-primary">Complete Onboarding</button>
                                </div>
                            )}
                        </div>
                    )}
